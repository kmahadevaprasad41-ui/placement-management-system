...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      {/* Back to Home Button */}
      <div className="absolute top-6 left-6">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-200 shadow-sm hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
        >
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <div className="flex items-center justify-center gap-2 mt-2">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-50 text-blue-800 border border-blue-200 dark:bg-blue-950/60 dark:border-blue-900 dark:text-blue-300">
        ...
        <div className="rounded-3xl border border-slate-200/80 bg-white/85 p-8 shadow-2xl backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/85 space-y-5">
          ...
          <div>
            <button
              ...
              className="w-full py-3 px-4 rounded-2xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 font-bold text-xs shadow-sm hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:border-blue-400 dark:hover:border-blue-500 transition-all flex items-center justify-center gap-3 group ring-1 ring-slate-900/5 hover:shadow-md"
            >
              ...
              <span className="text-sm font-extrabold">{isFirebaseLoading ? "Authenticating with Google..." : "Sign in with Google"}</span>
            </button>
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-wider">
                <span className="bg-white dark:bg-slate-900 px-3 text-slate-400">or sign in with password</span>
              </div>
            </div>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <Button
              ...
              size="md"
              isLoading={isLoading}
              className="w-full text-xs font-bold gap-1.5 py-3 shadow-md"
            >
